...
namespace HotChocolate.PreProcessedExtensions.Pagination
{
    ...
    public class PreProcessedCursorPagingProvider : CursorPagingProvider
    {
        ...
        public override bool CanHandle(IExtendedType source)
        {
            ...
            bool isPreProcessedResult = typeof(IAmPreProcessedResult).IsAssignableFrom(source.Type);
        ...
        ///     HotChocolate handles alot of dynamic Schema and Class type generation, therefore this must be
