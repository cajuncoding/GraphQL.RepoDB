...
namespace HotChocolate.ResolverProcessingExtensions.Selections
{
    public static class IResolverContextSelectionExtensions
    {
        ...
        /// <returns></returns>
        public static IReadOnlyList<ResolverProcessingSelection> GetResolverProcessingSelections(this IResolverContext? context)
        {
            if (context == null)
                return null!;
        ...
        /// <returns></returns>
        private static ResolverProcessingSelection FindChildSelectionByName(IResolverContext? context, string selectionFieldName, ResolverProcessingSelection? baseSelection)
        {
            if (context == null)
                return null!;
        ...
        /// <param name="baseSelection"></param>
        /// <returns></returns>
        private static List<ResolverProcessingSelection> GatherChildSelections(IResolverContext? context, ResolverProcessingSelection? baseSelection = null)
        {
            if (context == null)
                return null!;
            ...
            var gatheredSelections = possibleTypes
                ...
                .Select(sf => new ResolverProcessingSelection(sf))
                .ToList();
